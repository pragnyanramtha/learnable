...
export const subjects: SubjectConfig[] = [
  ...
  { id: 'algorithms', title: 'Algorithms', description: 'Searching, sorting, recursion, and how to compare program efficiency.' },
  ...
  { id: 'et-cetera', title: 'Et Cetera', description: 'File I/O, regular expressions, and useful Python extras for stronger programs.' },
];
...
export const examEvents: ClassEvent[] = [
  ...
  { date: '01-06-2026', day: 'Monday', time: '6:00 PM - 7:00 PM', title: 'File I/O', slug: 'et-cetera' },
  { date: '04-06-2026', day: 'Thursday', time: '6:00 PM - 7:00 PM', title: 'Regular Expressions', slug: 'et-cetera' },
